var bow , arrow,  scene;
var bowImage, arrowImage, green_balloonImage, red_balloonImage,red_balloon, pink_balloonImage ,blue_balloonImage, backgroundImage;
...
function setup() {
  ...
  bow.scale = 1;
   ...
   // creating balloons
   red_balloon=createSprite(150,200,20,20); 
   red_balloon.addImage(red_balloonImage) ;
   red_balloon.scale=0.08; 
